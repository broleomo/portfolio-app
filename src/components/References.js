...
export default class References extends Component {
  render(){
    return(
      ...
      <Card className="card">
       <CardImg top width="100%" src="http://www.billboard.com/files/styles/article_main_image/public/media/cher-press-2014-650-430.jpg" width="200px" alt="Card image cap" />
       <CardBlock>
     ...
     <Card className="card">
      <CardImg top width="100%" src="http://www.billboard.com/files/styles/article_main_image/public/media/ilana-glazer-spike-press-2015-billboard-650.jpg" width="200px" alt="Card image cap" />
      <CardBlock>
        ...
        <CardText>
          <small className="text-muted">December 2, 2014</small>
        </CardText>
      </CardBlock>
    </Card>
    <Card className="card">
     <CardImg top width="100%" src="http://ksassets.timeincuk.net/wp/uploads/sites/55/2015/07/2014StVincent_NME_1ST_120214.jpg" width="200px" alt="Card image cap" />
     <CardBlock>
